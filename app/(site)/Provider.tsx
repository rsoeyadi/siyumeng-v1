    ...
    <html lang="en">
      <body className={`${nunito.className} mx-auto my-0 overscroll-none`}>
        <p
          ...
          className="absolute top-0 left-0 text-[1.5em] xl:text-4xl pt-5 pl-2 font-bold lg:ml-5 lg:mt-4 text-white ease-in-out duration-300 hover:scale-105 z-[10000] uppercase"
        >
